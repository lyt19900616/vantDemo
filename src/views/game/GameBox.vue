<template>
    <div class="game-div">
      <h1>小药片</h1>
      <p>各种药品专治各类疑难杂症,如若没找到合适自己的药片,请致电憨憨政委申请，由憨憨团长发货</p>
      <div class="frame">
        <button class="custom-btn btn-1" @click="$router.push('/audioRecorder')">语音录制</button>
        <button class="custom-btn btn-2">拼图</button>
        <button class="custom-btn btn-3"><span>乒乓球</span></button>
...
<style scoped>
  ...
  .custom-btn {
    ...
    inset -7px -7px 10px 0 rgba(0,0,0,.1),7px 7px 20px 0 rgba(0,0,0,.1),
  ...
  .btn-13:after {
    ...
    box-shadow:inset 2px 2px 2px 0 rgba(255,255,255,.5),
    inset -7px -7px 10px 0 rgba(0,0,0,.1),
    7px 7px 20px 0 rgba(0,0,0,.1),
    4px 4px 5px 0 rgba(0,0,0,.1);
